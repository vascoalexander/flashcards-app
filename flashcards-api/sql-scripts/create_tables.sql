...
('Welche der folgenden sind relationale Datenbankmanagementsysteme?', 'PostgreSQL, MySQL, Oracle', 'MULTIPLE_CHOICE'),
('Welche HTTP-Methoden sind idempotent?', 'GET, PUT, DELETE', 'MULTIPLE_CHOICE'),
('Welche Programmiersprachen sind objektorientiert?', 'Java, C++, Python', 'MULTIPLE_CHOICE'),
('Welche Datentypen gibt es in JavaScript?', 'String, Number, Boolean, Object', 'MULTIPLE_CHOICE'),
('Welche der folgenden sind Eigenschaften von REST APIs?', 'Stateless, Cacheable, Uniform Interface',
 'MULTIPLE_CHOICE'),

-- Single Choice Fragen (eine richtige Antwort)
('Welche Datenstruktur arbeitet nach dem LIFO-Prinzip?', 'Stack', 'SINGLE_CHOICE'),
('Welcher HTTP-Statuscode steht für "Not Found"?', '404', 'SINGLE_CHOICE'),
('Was bedeutet die Abkürzung CPU?', 'Central Processing Unit', 'SINGLE_CHOICE'),
('Welches OSI-Layer ist für die Datenübertragung zwischen Netzwerkknoten zuständig?', 'Layer 2 (Data Link Layer)',
 'SINGLE_CHOICE'),
('Welcher Algorithmus hat die beste durchschnittliche Zeitkomplexität für Sortierung?', 'Quick Sort', 'SINGLE_CHOICE'),
